//gcc des_encrypt.c -o des_encrypt -lcrypto - компилираме първо  des_encrypt.c
//./des_encrypt
//qwerty // пишем криптиран текст пример
//e03e11e45afb3a24
//gcc des_decrypt.c -o des_decrypt -lcrypto // компилираме des_decrypt.c
////./des_decrypt
//e03e11e45afb3a24 // това е криптирания текст след като го поставим, ако е правилен трябва конзолата да изведе -> qwerty
//qwerty
